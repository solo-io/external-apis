...
func (m *MockWasmPluginSet) GetEqualityFunc() func(client.Object, client.Object) bool {
	m.ctrl.T.Helper()
...
func (mr *MockWasmPluginSetMockRecorder) GetEqualityFunc() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEqualityFunc", reflect.TypeOf((*MockWasmPluginSet)(nil).GetEqualityFunc))
}

// GetSortFunc mocks base method.
func (m *MockWasmPluginSet) GetSortFunc() func(client.Object, client.Object) bool {
	m.ctrl.T.Helper()
...
func (mr *MockWasmPluginSetMockRecorder) GetSortFunc() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSortFunc", reflect.TypeOf((*MockWasmPluginSet)(nil).GetSortFunc))
}
