...
type DestinationRuleStatusWriter interface {
	...
	UpdateDestinationRuleStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.DestinationRule, opts ...client.SubResourceUpdateOption) error

	// Patch patches the given DestinationRule object's subresource.
	PatchDestinationRuleStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.DestinationRule, patch client.Patch, opts ...client.SubResourcePatchOption) error
}
...
func (c *destinationRuleClient) UpdateDestinationRuleStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.DestinationRule, opts ...client.SubResourceUpdateOption) error {
	return c.client.Status().Update(ctx, obj, opts...)
}

func (c *destinationRuleClient) PatchDestinationRuleStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.DestinationRule, patch client.Patch, opts ...client.SubResourcePatchOption) error {
...
type GatewayStatusWriter interface {
	...
	UpdateGatewayStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.Gateway, opts ...client.SubResourceUpdateOption) error

	// Patch patches the given Gateway object's subresource.
	PatchGatewayStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.Gateway, patch client.Patch, opts ...client.SubResourcePatchOption) error
}
...
func (c *gatewayClient) UpdateGatewayStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.Gateway, opts ...client.SubResourceUpdateOption) error {
	return c.client.Status().Update(ctx, obj, opts...)
}

func (c *gatewayClient) PatchGatewayStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.Gateway, patch client.Patch, opts ...client.SubResourcePatchOption) error {
	return c.client.Status().Patch(ctx, obj, patch, opts...)
}
...
type ServiceEntryStatusWriter interface {
	...
	UpdateServiceEntryStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.ServiceEntry, opts ...client.SubResourceUpdateOption) error

	// Patch patches the given ServiceEntry object's subresource.
	PatchServiceEntryStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.ServiceEntry, patch client.Patch, opts ...client.SubResourcePatchOption) error
}
...
func (c *serviceEntryClient) UpdateServiceEntryStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.ServiceEntry, opts ...client.SubResourceUpdateOption) error {
	return c.client.Status().Update(ctx, obj, opts...)
}

func (c *serviceEntryClient) PatchServiceEntryStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.ServiceEntry, patch client.Patch, opts ...client.SubResourcePatchOption) error {
	return c.client.Status().Patch(ctx, obj, patch, opts...)
}
...
type WorkloadEntryStatusWriter interface {
	...
	UpdateWorkloadEntryStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadEntry, opts ...client.SubResourceUpdateOption) error

	// Patch patches the given WorkloadEntry object's subresource.
	PatchWorkloadEntryStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadEntry, patch client.Patch, opts ...client.SubResourcePatchOption) error
}
...
func (c *workloadEntryClient) UpdateWorkloadEntryStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadEntry, opts ...client.SubResourceUpdateOption) error {
	return c.client.Status().Update(ctx, obj, opts...)
}

func (c *workloadEntryClient) PatchWorkloadEntryStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadEntry, patch client.Patch, opts ...client.SubResourcePatchOption) error {
	return c.client.Status().Patch(ctx, obj, patch, opts...)
}
...
type WorkloadGroupReader interface {
	...
	GetWorkloadGroup(ctx context.Context, key client.ObjectKey) (*networking_istio_io_v1alpha3.WorkloadGroup, error)

	// List retrieves list of WorkloadGroups for a given namespace and list options.
	ListWorkloadGroup(ctx context.Context, opts ...client.ListOption) (*networking_istio_io_v1alpha3.WorkloadGroupList, error)
}
...
type WorkloadGroupTransitionFunction func(existing, desired *networking_istio_io_v1alpha3.WorkloadGroup) error
...
type WorkloadGroupWriter interface {
	...
	CreateWorkloadGroup(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadGroup, opts ...client.CreateOption) error
	...
	UpdateWorkloadGroup(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadGroup, opts ...client.UpdateOption) error

	// Patch patches the given WorkloadGroup object.
	PatchWorkloadGroup(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadGroup, patch client.Patch, opts ...client.PatchOption) error
	...
	UpsertWorkloadGroup(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadGroup, transitionFuncs ...WorkloadGroupTransitionFunction) error
}
...
type WorkloadGroupStatusWriter interface {
	...
	UpdateWorkloadGroupStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadGroup, opts ...client.SubResourceUpdateOption) error

	// Patch patches the given WorkloadGroup object's subresource.
	PatchWorkloadGroupStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadGroup, patch client.Patch, opts ...client.SubResourcePatchOption) error
}
...
func (c *workloadGroupClient) GetWorkloadGroup(ctx context.Context, key client.ObjectKey) (*networking_istio_io_v1alpha3.WorkloadGroup, error) {
	obj := &networking_istio_io_v1alpha3.WorkloadGroup{}
	if err := c.client.Get(ctx, key, obj); err != nil {
		return nil, err
	}
	return obj, nil
...
func (c *workloadGroupClient) ListWorkloadGroup(ctx context.Context, opts ...client.ListOption) (*networking_istio_io_v1alpha3.WorkloadGroupList, error) {
	list := &networking_istio_io_v1alpha3.WorkloadGroupList{}
	if err := c.client.List(ctx, list, opts...); err != nil {
		return nil, err
	}
	return list, nil
...
func (c *workloadGroupClient) CreateWorkloadGroup(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadGroup, opts ...client.CreateOption) error {
	return c.client.Create(ctx, obj, opts...)
}
...
func (c *workloadGroupClient) UpdateWorkloadGroup(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadGroup, opts ...client.UpdateOption) error {
	return c.client.Update(ctx, obj, opts...)
}

func (c *workloadGroupClient) PatchWorkloadGroup(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadGroup, patch client.Patch, opts ...client.PatchOption) error {
	return c.client.Patch(ctx, obj, patch, opts...)
}
...
func (c *workloadGroupClient) UpsertWorkloadGroup(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadGroup, transitionFuncs ...WorkloadGroupTransitionFunction) error {
	genericTxFunc := func(existing, desired runtime.Object) error {
		for _, txFunc := range transitionFuncs {
			if err := txFunc(existing.(*networking_istio_io_v1alpha3.WorkloadGroup), desired.(*networking_istio_io_v1alpha3.WorkloadGroup)); err != nil {
				return err
			}
		}
		return nil
...
func (c *workloadGroupClient) UpdateWorkloadGroupStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadGroup, opts ...client.SubResourceUpdateOption) error {
	return c.client.Status().Update(ctx, obj, opts...)
}

func (c *workloadGroupClient) PatchWorkloadGroupStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.WorkloadGroup, patch client.Patch, opts ...client.SubResourcePatchOption) error {
	return c.client.Status().Patch(ctx, obj, patch, opts...)
}
...
type VirtualServiceStatusWriter interface {
	...
	UpdateVirtualServiceStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.VirtualService, opts ...client.SubResourceUpdateOption) error

	// Patch patches the given VirtualService object's subresource.
	PatchVirtualServiceStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.VirtualService, patch client.Patch, opts ...client.SubResourcePatchOption) error
}
...
func (c *virtualServiceClient) UpdateVirtualServiceStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.VirtualService, opts ...client.SubResourceUpdateOption) error {
	return c.client.Status().Update(ctx, obj, opts...)
}

func (c *virtualServiceClient) PatchVirtualServiceStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.VirtualService, patch client.Patch, opts ...client.SubResourcePatchOption) error {
	return c.client.Status().Patch(ctx, obj, patch, opts...)
}
...
type SidecarStatusWriter interface {
	...
	UpdateSidecarStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.Sidecar, opts ...client.SubResourceUpdateOption) error

	// Patch patches the given Sidecar object's subresource.
	PatchSidecarStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.Sidecar, patch client.Patch, opts ...client.SubResourcePatchOption) error
}
...
func (c *sidecarClient) UpdateSidecarStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.Sidecar, opts ...client.SubResourceUpdateOption) error {
	return c.client.Status().Update(ctx, obj, opts...)
}

func (c *sidecarClient) PatchSidecarStatus(ctx context.Context, obj *networking_istio_io_v1alpha3.Sidecar, patch client.Patch, opts ...client.SubResourcePatchOption) error {
	return c.client.Status().Patch(ctx, obj, patch, opts...)
}
