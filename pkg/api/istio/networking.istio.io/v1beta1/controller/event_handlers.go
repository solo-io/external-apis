...
type EnvoyFilterEventHandler interface {
	CreateEnvoyFilter(obj *networking_istio_io_v1beta1.EnvoyFilter) error
	UpdateEnvoyFilter(old, new *networking_istio_io_v1beta1.EnvoyFilter) error
	DeleteEnvoyFilter(obj *networking_istio_io_v1beta1.EnvoyFilter) error
	GenericEnvoyFilter(obj *networking_istio_io_v1beta1.EnvoyFilter) error
}

type EnvoyFilterEventHandlerFuncs struct {
	OnCreate  func(obj *networking_istio_io_v1beta1.EnvoyFilter) error
	OnUpdate  func(old, new *networking_istio_io_v1beta1.EnvoyFilter) error
	OnDelete  func(obj *networking_istio_io_v1beta1.EnvoyFilter) error
	OnGeneric func(obj *networking_istio_io_v1beta1.EnvoyFilter) error
}

func (f *EnvoyFilterEventHandlerFuncs) CreateEnvoyFilter(obj *networking_istio_io_v1beta1.EnvoyFilter) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *EnvoyFilterEventHandlerFuncs) DeleteEnvoyFilter(obj *networking_istio_io_v1beta1.EnvoyFilter) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *EnvoyFilterEventHandlerFuncs) UpdateEnvoyFilter(objOld, objNew *networking_istio_io_v1beta1.EnvoyFilter) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *EnvoyFilterEventHandlerFuncs) GenericEnvoyFilter(obj *networking_istio_io_v1beta1.EnvoyFilter) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewEnvoyFilterEventWatcher(name string, mgr manager.Manager) EnvoyFilterEventWatcher {
	return &envoyFilterEventWatcher{
		watcher: events.NewWatcher(name, mgr, &networking_istio_io_v1beta1.EnvoyFilter{}),
	}
}
...
func (h genericEnvoyFilterHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*networking_istio_io_v1beta1.EnvoyFilter)
	if !ok {
		return errors.Errorf("internal error: EnvoyFilter handler received event for %T", old)
	}
	objNew, ok := new.(*networking_istio_io_v1beta1.EnvoyFilter)
	if !ok {
