...
func (f *MulticlusterDestinationRuleReconcilerFuncs) ReconcileDestinationRule(clusterName string, obj *networking_istio_io_v1beta1.DestinationRule) (reconcile.Result, error) {
...
func NewMulticlusterDestinationRuleReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterDestinationRuleReconcileLoop {
	return &multiclusterDestinationRuleReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_istio_io_v1beta1.DestinationRule{}, options)}
}
...
type MulticlusterEnvoyFilterReconciler interface {
	ReconcileEnvoyFilter(clusterName string, obj *networking_istio_io_v1beta1.EnvoyFilter) (reconcile.Result, error)
}
...
type MulticlusterEnvoyFilterReconcilerFuncs struct {
	OnReconcileEnvoyFilter         func(clusterName string, obj *networking_istio_io_v1beta1.EnvoyFilter) (reconcile.Result, error)
	OnReconcileEnvoyFilterDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterEnvoyFilterReconcilerFuncs) ReconcileEnvoyFilter(clusterName string, obj *networking_istio_io_v1beta1.EnvoyFilter) (reconcile.Result, error) {
...
func NewMulticlusterEnvoyFilterReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterEnvoyFilterReconcileLoop {
	return &multiclusterEnvoyFilterReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_istio_io_v1beta1.EnvoyFilter{}, options)}
}
...
func (g genericEnvoyFilterMulticlusterReconciler) Reconcile(cluster string, object ezkube.Object) (reconcile.Result, error) {
	obj, ok := object.(*networking_istio_io_v1beta1.EnvoyFilter)
	if !ok {
...
func (f *MulticlusterGatewayReconcilerFuncs) ReconcileGateway(clusterName string, obj *networking_istio_io_v1beta1.Gateway) (reconcile.Result, error) {
...
func NewMulticlusterGatewayReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterGatewayReconcileLoop {
	return &multiclusterGatewayReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_istio_io_v1beta1.Gateway{}, options)}
}
...
func (f *MulticlusterServiceEntryReconcilerFuncs) ReconcileServiceEntry(clusterName string, obj *networking_istio_io_v1beta1.ServiceEntry) (reconcile.Result, error) {
...
func NewMulticlusterServiceEntryReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterServiceEntryReconcileLoop {
	return &multiclusterServiceEntryReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_istio_io_v1beta1.ServiceEntry{}, options)}
}
...
func (f *MulticlusterWorkloadEntryReconcilerFuncs) ReconcileWorkloadEntry(clusterName string, obj *networking_istio_io_v1beta1.WorkloadEntry) (reconcile.Result, error) {
...
func NewMulticlusterWorkloadEntryReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterWorkloadEntryReconcileLoop {
	return &multiclusterWorkloadEntryReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_istio_io_v1beta1.WorkloadEntry{}, options)}
}
...
func (f *MulticlusterVirtualServiceReconcilerFuncs) ReconcileVirtualService(clusterName string, obj *networking_istio_io_v1beta1.VirtualService) (reconcile.Result, error) {
...
func NewMulticlusterVirtualServiceReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterVirtualServiceReconcileLoop {
	return &multiclusterVirtualServiceReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_istio_io_v1beta1.VirtualService{}, options)}
}
...
func (f *MulticlusterSidecarReconcilerFuncs) ReconcileSidecar(clusterName string, obj *networking_istio_io_v1beta1.Sidecar) (reconcile.Result, error) {
...
func NewMulticlusterSidecarReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterSidecarReconcileLoop {
	return &multiclusterSidecarReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_istio_io_v1beta1.Sidecar{}, options)}
}
