...
func (m *MockEnvoyFilterEventHandler) CreateEnvoyFilter(obj *v1beta1.EnvoyFilter) error {
	m.ctrl.T.Helper()
...
func (m *MockEnvoyFilterEventHandler) DeleteEnvoyFilter(obj *v1beta1.EnvoyFilter) error {
	m.ctrl.T.Helper()
...
func (m *MockEnvoyFilterEventHandler) GenericEnvoyFilter(obj *v1beta1.EnvoyFilter) error {
	m.ctrl.T.Helper()
...
func (m *MockEnvoyFilterEventHandler) UpdateEnvoyFilter(old, new *v1beta1.EnvoyFilter) error {
	m.ctrl.T.Helper()
