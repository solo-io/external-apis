...
func (m *MockEnvoyFilterReconciler) ReconcileEnvoyFilter(obj *v1beta1.EnvoyFilter) (reconcile.Result, error) {
	m.ctrl.T.Helper()
...
func (m *MockEnvoyFilterFinalizer) FinalizeEnvoyFilter(obj *v1beta1.EnvoyFilter) error {
	m.ctrl.T.Helper()
...
// ReconcileEnvoyFilter mocks base method.
func (m *MockEnvoyFilterFinalizer) ReconcileEnvoyFilter(obj *v1beta1.EnvoyFilter) (reconcile.Result, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReconcileEnvoyFilter", obj)
	ret0, _ := ret[0].(reconcile.Result)
	ret1, _ := ret[1].(error)
