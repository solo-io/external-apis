...
type EnvoyFilterSet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*networking_istio_io_v1beta1.EnvoyFilter) bool) []*networking_istio_io_v1beta1.EnvoyFilter
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*networking_istio_io_v1beta1.EnvoyFilter) bool) []*networking_istio_io_v1beta1.EnvoyFilter
	// Return the Set as a map of key to resource.
	Map() map[string]*networking_istio_io_v1beta1.EnvoyFilter
	// Insert a resource into the set.
	Insert(envoyFilter ...*networking_istio_io_v1beta1.EnvoyFilter)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*networking_istio_io_v1beta1.EnvoyFilter, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericEnvoyFilterSet(envoyFilterList []*networking_istio_io_v1beta1.EnvoyFilter) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewEnvoyFilterSet(envoyFilterList ...*networking_istio_io_v1beta1.EnvoyFilter) EnvoyFilterSet {
	return &envoyFilterSet{set: makeGenericEnvoyFilterSet(envoyFilterList)}
}

func NewEnvoyFilterSetFromList(envoyFilterList *networking_istio_io_v1beta1.EnvoyFilterList) EnvoyFilterSet {
	list := make([]*networking_istio_io_v1beta1.EnvoyFilter, 0, len(envoyFilterList.Items))
...
func (s *envoyFilterSet) List(filterResource ...func(*networking_istio_io_v1beta1.EnvoyFilter) bool) []*networking_istio_io_v1beta1.EnvoyFilter {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		filter := filter
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*networking_istio_io_v1beta1.EnvoyFilter))
		})
	}

	objs := s.Generic().List(genericFilters...)
	envoyFilterList := make([]*networking_istio_io_v1beta1.EnvoyFilter, 0, len(objs))
	for _, obj := range objs {
		envoyFilterList = append(envoyFilterList, obj.(*networking_istio_io_v1beta1.EnvoyFilter))
	}
	return envoyFilterList
}

func (s *envoyFilterSet) UnsortedList(filterResource ...func(*networking_istio_io_v1beta1.EnvoyFilter) bool) []*networking_istio_io_v1beta1.EnvoyFilter {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var envoyFilterList []*networking_istio_io_v1beta1.EnvoyFilter
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		envoyFilterList = append(envoyFilterList, obj.(*networking_istio_io_v1beta1.EnvoyFilter))
	}
	return envoyFilterList
...
func (s *envoyFilterSet) Map() map[string]*networking_istio_io_v1beta1.EnvoyFilter {
	if s == nil {
		return nil
	}

	newMap := map[string]*networking_istio_io_v1beta1.EnvoyFilter{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*networking_istio_io_v1beta1.EnvoyFilter)
	}
	return newMap
}

func (s *envoyFilterSet) Insert(
	envoyFilterList ...*networking_istio_io_v1beta1.EnvoyFilter,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *envoyFilterSet) Find(id ezkube.ResourceId) (*networking_istio_io_v1beta1.EnvoyFilter, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find EnvoyFilter %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&networking_istio_io_v1beta1.EnvoyFilter{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*networking_istio_io_v1beta1.EnvoyFilter), nil
}
