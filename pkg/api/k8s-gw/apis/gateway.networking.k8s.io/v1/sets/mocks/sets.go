...
import (
	...
	v1sets "github.com/solo-io/external-apis/pkg/api/k8s-gw/apis/gateway.networking.k8s.io/v1/sets"
...
func (m *MockGatewayClassSet) Clone() v1sets.GatewayClassSet {
	...
	ret0, _ := ret[0].(v1sets.GatewayClassSet)
	return ret0
}
...
func (m *MockHTTPRouteSet) Clone() v1sets.HTTPRouteSet {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Clone")
	ret0, _ := ret[0].(v1sets.HTTPRouteSet)
	return ret0
}
