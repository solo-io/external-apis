...
import (
	...
	v1 "github.com/solo-io/external-apis/pkg/api/k8s-gw/apis/gateway.networking.k8s.io/v1"
...
func (m *MockGatewayClassReader) GetGatewayClass(ctx context.Context, key client.ObjectKey) (*v10.GatewayClass, error) {
	m.ctrl.T.Helper()
...
func (mr *MockGatewayClassReaderMockRecorder) GetGatewayClass(ctx, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetGatewayClass", reflect.TypeOf((*MockGatewayClassReader)(nil).GetGatewayClass), ctx, key)
}
...
func (m *MockGatewayClassWriter) DeleteGatewayClass(ctx context.Context, key client.ObjectKey, opts ...client.DeleteOption) error {
	m.ctrl.T.Helper()
...
func (mr *MockGatewayClassWriterMockRecorder) DeleteGatewayClass(ctx, key interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// DeleteGatewayClass mocks base method.
func (m *MockGatewayClassClient) DeleteGatewayClass(ctx context.Context, key client.ObjectKey, opts ...client.DeleteOption) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, key}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// DeleteGatewayClass indicates an expected call of DeleteGatewayClass.
func (mr *MockGatewayClassClientMockRecorder) DeleteGatewayClass(ctx, key interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, key}, opts...)
...
// GetGatewayClass mocks base method.
func (m *MockGatewayClassClient) GetGatewayClass(ctx context.Context, key client.ObjectKey) (*v10.GatewayClass, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetGatewayClass", ctx, key)
	ret0, _ := ret[0].(*v10.GatewayClass)
	ret1, _ := ret[1].(error)
...
// GetGatewayClass indicates an expected call of GetGatewayClass.
func (mr *MockGatewayClassClientMockRecorder) GetGatewayClass(ctx, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetGatewayClass", reflect.TypeOf((*MockGatewayClassClient)(nil).GetGatewayClass), ctx, key)
}
