...
type ReferenceGrantReader interface {
	...
	GetReferenceGrant(ctx context.Context, key client.ObjectKey) (*gateway_networking_k8s_io_v1beta1.ReferenceGrant, error)

	// List retrieves list of ReferenceGrants for a given namespace and list options.
	ListReferenceGrant(ctx context.Context, opts ...client.ListOption) (*gateway_networking_k8s_io_v1beta1.ReferenceGrantList, error)
}
...
type ReferenceGrantTransitionFunction func(existing, desired *gateway_networking_k8s_io_v1beta1.ReferenceGrant) error
...
type ReferenceGrantWriter interface {
	...
	CreateReferenceGrant(ctx context.Context, obj *gateway_networking_k8s_io_v1beta1.ReferenceGrant, opts ...client.CreateOption) error
	...
	UpdateReferenceGrant(ctx context.Context, obj *gateway_networking_k8s_io_v1beta1.ReferenceGrant, opts ...client.UpdateOption) error

	// Patch patches the given ReferenceGrant object.
	PatchReferenceGrant(ctx context.Context, obj *gateway_networking_k8s_io_v1beta1.ReferenceGrant, patch client.Patch, opts ...client.PatchOption) error
	...
	UpsertReferenceGrant(ctx context.Context, obj *gateway_networking_k8s_io_v1beta1.ReferenceGrant, transitionFuncs ...ReferenceGrantTransitionFunction) error
}
...
type ReferenceGrantStatusWriter interface {
	...
	UpdateReferenceGrantStatus(ctx context.Context, obj *gateway_networking_k8s_io_v1beta1.ReferenceGrant, opts ...client.SubResourceUpdateOption) error

	// Patch patches the given ReferenceGrant object's subresource.
	PatchReferenceGrantStatus(ctx context.Context, obj *gateway_networking_k8s_io_v1beta1.ReferenceGrant, patch client.Patch, opts ...client.SubResourcePatchOption) error
}
...
func (c *referenceGrantClient) GetReferenceGrant(ctx context.Context, key client.ObjectKey) (*gateway_networking_k8s_io_v1beta1.ReferenceGrant, error) {
	obj := &gateway_networking_k8s_io_v1beta1.ReferenceGrant{}
	if err := c.client.Get(ctx, key, obj); err != nil {
		return nil, err
	}
	return obj, nil
...
func (c *referenceGrantClient) ListReferenceGrant(ctx context.Context, opts ...client.ListOption) (*gateway_networking_k8s_io_v1beta1.ReferenceGrantList, error) {
	list := &gateway_networking_k8s_io_v1beta1.ReferenceGrantList{}
	if err := c.client.List(ctx, list, opts...); err != nil {
		return nil, err
	}
	return list, nil
...
func (c *referenceGrantClient) CreateReferenceGrant(ctx context.Context, obj *gateway_networking_k8s_io_v1beta1.ReferenceGrant, opts ...client.CreateOption) error {
	return c.client.Create(ctx, obj, opts...)
}
...
func (c *referenceGrantClient) UpdateReferenceGrant(ctx context.Context, obj *gateway_networking_k8s_io_v1beta1.ReferenceGrant, opts ...client.UpdateOption) error {
	return c.client.Update(ctx, obj, opts...)
}

func (c *referenceGrantClient) PatchReferenceGrant(ctx context.Context, obj *gateway_networking_k8s_io_v1beta1.ReferenceGrant, patch client.Patch, opts ...client.PatchOption) error {
	return c.client.Patch(ctx, obj, patch, opts...)
}
...
func (c *referenceGrantClient) UpsertReferenceGrant(ctx context.Context, obj *gateway_networking_k8s_io_v1beta1.ReferenceGrant, transitionFuncs ...ReferenceGrantTransitionFunction) error {
	genericTxFunc := func(existing, desired runtime.Object) error {
		for _, txFunc := range transitionFuncs {
			if err := txFunc(existing.(*gateway_networking_k8s_io_v1beta1.ReferenceGrant), desired.(*gateway_networking_k8s_io_v1beta1.ReferenceGrant)); err != nil {
				return err
			}
		}
		return nil
...
func (c *referenceGrantClient) UpdateReferenceGrantStatus(ctx context.Context, obj *gateway_networking_k8s_io_v1beta1.ReferenceGrant, opts ...client.SubResourceUpdateOption) error {
	return c.client.Status().Update(ctx, obj, opts...)
}

func (c *referenceGrantClient) PatchReferenceGrantStatus(ctx context.Context, obj *gateway_networking_k8s_io_v1beta1.ReferenceGrant, patch client.Patch, opts ...client.SubResourcePatchOption) error {
	return c.client.Status().Patch(ctx, obj, patch, opts...)
}
