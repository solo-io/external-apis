...
type MulticlusterReferenceGrantReconciler interface {
	ReconcileReferenceGrant(clusterName string, obj *gateway_networking_k8s_io_v1alpha2.ReferenceGrant) (reconcile.Result, error)
}
...
type MulticlusterReferenceGrantReconcilerFuncs struct {
	OnReconcileReferenceGrant         func(clusterName string, obj *gateway_networking_k8s_io_v1alpha2.ReferenceGrant) (reconcile.Result, error)
	OnReconcileReferenceGrantDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterReferenceGrantReconcilerFuncs) ReconcileReferenceGrant(clusterName string, obj *gateway_networking_k8s_io_v1alpha2.ReferenceGrant) (reconcile.Result, error) {
...
func NewMulticlusterReferenceGrantReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterReferenceGrantReconcileLoop {
	return &multiclusterReferenceGrantReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &gateway_networking_k8s_io_v1alpha2.ReferenceGrant{}, options)}
}
