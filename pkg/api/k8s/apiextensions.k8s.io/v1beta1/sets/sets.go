...
func makeGenericCustomResourceDefinitionSet(
	...
	genericSortFunc := func(toInsert, existing ezkube.ResourceId) bool {
		...
		if !ok {
			objToInsert = &apiextensions_k8s_io_v1beta1.CustomResourceDefinition{
		...
		if !ok {
			objExisting = &apiextensions_k8s_io_v1beta1.CustomResourceDefinition{
				ObjectMeta: metav1.ObjectMeta{
	...
	genericEqualityFunc := func(a, b ezkube.ResourceId) bool {
		...
		if !ok {
			objA = &apiextensions_k8s_io_v1beta1.CustomResourceDefinition{
				ObjectMeta: metav1.ObjectMeta{
					Name:      a.GetName(),
		...
		if !ok {
			objB = &apiextensions_k8s_io_v1beta1.CustomResourceDefinition{
				ObjectMeta: metav1.ObjectMeta{
					Name:      b.GetName(),
