...
func NewClientsetFromConfig(cfg *rest.Config) (Clientset, error) {
	...
	if err := split_smi_spec_io_v1alpha3.SchemeBuilder.AddToScheme(scheme); err != nil {
		return nil, err
	}
...
type TrafficSplitStatusWriter interface {
	...
	UpdateTrafficSplitStatus(ctx context.Context, obj *split_smi_spec_io_v1alpha3.TrafficSplit, opts ...client.SubResourceUpdateOption) error

	// Patch patches the given TrafficSplit object's subresource.
	PatchTrafficSplitStatus(ctx context.Context, obj *split_smi_spec_io_v1alpha3.TrafficSplit, patch client.Patch, opts ...client.SubResourcePatchOption) error
}
...
func (c *trafficSplitClient) UpdateTrafficSplitStatus(ctx context.Context, obj *split_smi_spec_io_v1alpha3.TrafficSplit, opts ...client.SubResourceUpdateOption) error {
	return c.client.Status().Update(ctx, obj, opts...)
}

func (c *trafficSplitClient) PatchTrafficSplitStatus(ctx context.Context, obj *split_smi_spec_io_v1alpha3.TrafficSplit, patch client.Patch, opts ...client.SubResourcePatchOption) error {
