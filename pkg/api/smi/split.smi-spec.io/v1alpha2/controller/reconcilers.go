...
type TrafficSplitReconciler interface {
	ReconcileTrafficSplit(obj *split_smi_spec_io_v1alpha2.TrafficSplit) (reconcile.Result, error)
}
...
type TrafficSplitReconcilerFuncs struct {
	OnReconcileTrafficSplit         func(obj *split_smi_spec_io_v1alpha2.TrafficSplit) (reconcile.Result, error)
	OnReconcileTrafficSplitDeletion func(req reconcile.Request) error
}

func (f *TrafficSplitReconcilerFuncs) ReconcileTrafficSplit(obj *split_smi_spec_io_v1alpha2.TrafficSplit) (reconcile.Result, error) {
...
type TrafficSplitFinalizer interface {
	...
	FinalizeTrafficSplit(obj *split_smi_spec_io_v1alpha2.TrafficSplit) error
}
...
func NewTrafficSplitReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) TrafficSplitReconcileLoop {
	return &trafficSplitReconcileLoop{
		loop: reconcile.NewLoop(name, mgr, &split_smi_spec_io_v1alpha2.TrafficSplit{}, options),
	}
}
