...
type MulticlusterTrafficSplitReconciler interface {
	ReconcileTrafficSplit(clusterName string, obj *split_smi_spec_io_v1alpha2.TrafficSplit) (reconcile.Result, error)
}
...
type MulticlusterTrafficSplitReconcilerFuncs struct {
	OnReconcileTrafficSplit         func(clusterName string, obj *split_smi_spec_io_v1alpha2.TrafficSplit) (reconcile.Result, error)
	OnReconcileTrafficSplitDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterTrafficSplitReconcilerFuncs) ReconcileTrafficSplit(clusterName string, obj *split_smi_spec_io_v1alpha2.TrafficSplit) (reconcile.Result, error) {
...
func NewMulticlusterTrafficSplitReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterTrafficSplitReconcileLoop {
	return &multiclusterTrafficSplitReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &split_smi_spec_io_v1alpha2.TrafficSplit{}, options)}
}
