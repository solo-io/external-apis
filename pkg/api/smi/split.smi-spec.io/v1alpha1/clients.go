...
func (c *trafficSplitClient) UpdateTrafficSplitStatus(ctx context.Context, obj *split_smi_spec_io_v1alpha1.TrafficSplit, opts ...client.SubResourceUpdateOption) error {
	return c.client.Status().Update(ctx, obj, opts...)
}

func (c *trafficSplitClient) PatchTrafficSplitStatus(ctx context.Context, obj *split_smi_spec_io_v1alpha1.TrafficSplit, patch client.Patch, opts ...client.SubResourcePatchOption) error {
