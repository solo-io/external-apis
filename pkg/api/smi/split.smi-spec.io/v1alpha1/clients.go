...
type TrafficSplitStatusWriter interface {
	...
	UpdateTrafficSplitStatus(ctx context.Context, obj *split_smi_spec_io_v1alpha1.TrafficSplit, opts ...client.UpdateOption) error

	// Patch patches the given TrafficSplit object's subresource.
	PatchTrafficSplitStatus(ctx context.Context, obj *split_smi_spec_io_v1alpha1.TrafficSplit, patch client.Patch, opts ...client.PatchOption) error
}
...
func (c *trafficSplitClient) CreateTrafficSplit(ctx context.Context, obj *split_smi_spec_io_v1alpha1.TrafficSplit, opts ...client.CreateOption) error {
...
func (c *trafficSplitClient) UpdateTrafficSplit(ctx context.Context, obj *split_smi_spec_io_v1alpha1.TrafficSplit, opts ...client.UpdateOption) error {
	return c.client.Update(ctx, obj, opts...)
}

func (c *trafficSplitClient) PatchTrafficSplit(ctx context.Context, obj *split_smi_spec_io_v1alpha1.TrafficSplit, patch client.Patch, opts ...client.PatchOption) error {
...
func (c *trafficSplitClient) UpsertTrafficSplit(ctx context.Context, obj *split_smi_spec_io_v1alpha1.TrafficSplit, transitionFuncs ...TrafficSplitTransitionFunction) error {
	genericTxFunc := func(existing, desired runtime.Object) error {
		for _, txFunc := range transitionFuncs {
			if err := txFunc(existing.(*split_smi_spec_io_v1alpha1.TrafficSplit), desired.(*split_smi_spec_io_v1alpha1.TrafficSplit)); err != nil {
				return err
			}
		}
		return nil
...
func (c *trafficSplitClient) UpdateTrafficSplitStatus(ctx context.Context, obj *split_smi_spec_io_v1alpha1.TrafficSplit, opts ...client.UpdateOption) error {
