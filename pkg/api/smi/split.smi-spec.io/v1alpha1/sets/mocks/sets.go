...
func (m *MockTrafficSplitSet) Clone() v1alpha1sets.TrafficSplitSet {
	m.ctrl.T.Helper()
...
func (m *MockTrafficSplitSet) Delta(newSet v1alpha1sets.TrafficSplitSet) sets.ResourceDelta {
	m.ctrl.T.Helper()
...
func (m *MockTrafficSplitSet) GetEqualityFunc() func(client.Object, client.Object) bool {
	m.ctrl.T.Helper()
...
func (mr *MockTrafficSplitSetMockRecorder) GetEqualityFunc() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEqualityFunc", reflect.TypeOf((*MockTrafficSplitSet)(nil).GetEqualityFunc))
}

// GetSortFunc mocks base method.
func (m *MockTrafficSplitSet) GetSortFunc() func(client.Object, client.Object) bool {
	m.ctrl.T.Helper()
...
func (mr *MockTrafficSplitSetMockRecorder) GetSortFunc() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSortFunc", reflect.TypeOf((*MockTrafficSplitSet)(nil).GetSortFunc))
}
...
func (m *MockTrafficSplitSet) List(filterResource ...func(*v1alpha1.TrafficSplit) bool) []*v1alpha1.TrafficSplit {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
...
func (m *MockTrafficSplitSet) UnsortedList(filterResource ...func(*v1alpha1.TrafficSplit) bool) []*v1alpha1.TrafficSplit {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
	for _, a := range filterResource {
		varargs = append(varargs, a)
