...
func (h genericHTTPRouteGroupHandler) Create(object client.Object) error {
...
func (h genericHTTPRouteGroupHandler) Delete(object client.Object) error {
	obj, ok := object.(*specs_smi_spec_io_v1alpha3.HTTPRouteGroup)
	if !ok {
		return errors.Errorf("internal error: HTTPRouteGroup handler received event for %T", object)
	}
...
func (h genericHTTPRouteGroupHandler) Update(old, new client.Object) error {
...
func (h genericHTTPRouteGroupHandler) Generic(object client.Object) error {
	obj, ok := object.(*specs_smi_spec_io_v1alpha3.HTTPRouteGroup)
	if !ok {
		return errors.Errorf("internal error: HTTPRouteGroup handler received event for %T", object)
	}
